...
bool CANInit(BITRATE bitrate, int remap)
{
  ...
  CANSetFilter(0, 1, 0, 0, 0x7F00000, 0);
  CANSetFilter(1, 1, 0, 0, 0x7DF0000, 0);
  CANSetFilter(2, 1, 0, 0, 0x7E10000, 0);
  CANSetFilter(3, 1, 0, 1, 0x7F00000, 0);
  CANSetFilter(4, 1, 0, 1, 0x7DF0000, 0);
  CANSetFilter(5, 1, 0, 1, 0x7E10000, 0);
